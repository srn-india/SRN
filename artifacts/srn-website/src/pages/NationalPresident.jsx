      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              {data.sections.map((sec) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-5 py-3.5 rounded-xl border text-[13px] font-semibold transition-all duration-300 whitespace-nowrap lg:whitespace-normal text-left shrink-0 lg:shrink w-auto lg:w-full group ${isSelected
            ...
            {/* Right Display Area */}
            <div className="w-full lg:w-3/4 min-h-[480px]">
              <AnimatePresence mode="wait">
                <motion.div
                  key={activeTab}
                ...
                >
                  {/* Decorative background glow matching tab colors */}
